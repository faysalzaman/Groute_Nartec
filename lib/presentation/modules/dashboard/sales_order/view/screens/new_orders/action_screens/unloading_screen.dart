  ...
  Widget _buildSalesInvoiceDetailCard(SalesInvoiceDetails item) {
    return GestureDetector(
      onTap: () {
        ...
        // Navigate to suggested product details screen
        AppNavigator.push(
          context,
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          subtitle: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildInfoRow('Product Name', item.productName ?? 'N/A'),
              _buildInfoRow('Product Price', item.price ?? 'N/A'),
              _buildInfoRow('Product Quantity', item.quantity ?? 'N/A'),
              _buildInfoRow(
                'Procuct Description',
